...
<div class="form">
  ...
  <input type="text" name="tb_firstname" value="" placeholder="Vul voornaam in"><br /> <!--fname input -->
  <input type="text" name="tb_lastname" value="" placeholder="Vul achternaam in"><br /> <!--lname input -->
  <input type="text" name="tb_city" value="" placeholder="Vul stad in"><br /> <!--lname input -->
  <input type="text" name="tb_street" value="" placeholder="Vul straat in"><br /> <!--lname input -->
  <input type="text" name="tb_housenumber" value="" placeholder="Vul huisnummer in"><br /> <!--lname input -->
  <input type="email" name="tb_email" value="" placeholder="Vul E-mail in"><br /> <!--lname input -->
  <input type="text" name="tb_telnum" value="" placeholder="Vul telefoon nummer in"><br /> <!--lname input -->
